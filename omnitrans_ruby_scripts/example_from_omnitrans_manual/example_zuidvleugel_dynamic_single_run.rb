...
#set simulation draw number to run (number between 1 and 10)
RESULT = 1

#Set the selection of controls you would like to run (i.e., User dimension):
...
myQuery.execute
#Set the correct set of controls to active (according to draw number)
if USER < 8
...
#Note: Change if you're running without disruptions, but you do want to have your own controls (measures) tested
if USER < 8
...
# Route choice: MSA with 7 iterations max
...
sl.output.aggregation = [300,5] #[300,5]
